...
#SBATCH --output=svd_pipeline_%j.out
#SBATCH --error=svd_pipeline_%j.err
...
echo " Start         : $(date)"
echo " Python script : ml_pipeline_svd_kmeans.py"
echo "======================================================"
...
singularity exec \
    ...
    python ml_pipeline_svd_kmeans.py
