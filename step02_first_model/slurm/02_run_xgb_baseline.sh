#!/bin/bash
#SBATCH --job-name=antarctic_xgb_baseline
...
#SBATCH --output=xgb_baseline_pipeline_%j.out
#SBATCH --error=xgb_baseline_pipeline_%j.err
...
echo " Start         : $(date)"
echo " Python script : 02_xgb_baseline.py"
echo "======================================================"
