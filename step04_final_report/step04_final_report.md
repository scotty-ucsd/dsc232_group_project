...
![Dataset Overview](imgs/fig_01_dataset_overview.png)

**Figure 2: Data Completeness**

![Data Completeness](imgs/fig_02_data_completeness.png)

**Figure 3: Feature Distributions -- Fused Dataset**

![Fused Histograms](imgs/fig_03_histograms_antarctica_sparse_features.png)
...
![Bedmap3 Histograms](imgs/fig_03_histograms_bedmap3_static.png)

![ICESat-2 Histograms](imgs/fig_03_histograms_icesat2_dynamic.png)

![Ocean Dynamic Histograms](imgs/fig_03_histograms_ocean_dynamic.png)

![GRACE Histograms](imgs/fig_03_histograms_grace.png)

**Figure 5: Feature Correlations -- Fused Dataset**

![Correlation Heatmap](imgs/fig_04_correlation_antarctica_sparse_features.png)
...
![Physical Ranges](imgs/fig_05b_physical_ranges_symlog.png)

**Figure 7: Missing Data Structure**

![Null Structure](imgs/fig_06_null_structure.png)
...
![Ice Mask](imgs/fig_07_ice_mask_ocean_coverage.png)
...
![Delta H vs LWE](imgs/fig_08_delta_h_vs_lwe_spatial.png)
...
![Delta H Timeseries](imgs/fig_09_delta_h_timeseries.png)

**Figure 11: Mean Ice Height (LWE) Over Time**

![LWE Timeseries](imgs/fig_10_lwe_timeseries.png)
